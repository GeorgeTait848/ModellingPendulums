...
let springPendModelSimulation = springPendulum_model.simulateSystem(numberOfIterations: 20000, relativeTol: 0.001)
...
let doublePendSimulation = Double_Pendulum_model.simulateSystem(numberOfIterations: 10000, relativeTol: 0.001)

let theta2Data = doublePendSimulation.getCoordinateAtAllIterations(coordinateIndex: 2)

//for i in 0..<theta2Data.count {
//
//    print(theta2Data[i])
//
//}
...
let duffingOscillatorSimulation = model_duffing_oscillator.simulateSystem(numberOfIterations: 20000, relativeTol: 0.01)
